...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/usr/local/lib/mipsel-linux-gnu"); SEARCH_DIR("=/lib/mipsel-linux-gnu"); SEARCH_DIR("=/usr/lib/mipsel-linux-gnu"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib"); SEARCH_DIR("=/usr/mipsel-linux-gnu/lib32"); SEARCH_DIR("=/usr/mipsel-linux-gnu/lib");
SECTIONS
{
